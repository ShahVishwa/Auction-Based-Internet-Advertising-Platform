...
public class ManageOrganizationJPanel extends javax.swing.JPanel {
    ...
    private void populateComboBox()
    {
        ...
        for (Organization.Type type : Organization.Type.values()){
            if (type.getValue().equals(Organization.Type.Advertiser.getValue()) || type.getValue().equals(Organization.Type.AdvertiserFinance.getValue()) || type.getValue().equals(Organization.Type.Marketer.getValue()))
