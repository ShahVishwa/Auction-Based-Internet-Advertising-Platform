...
public class RequestPaymentJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        messageJLabel.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(0, 153, 204)));

        messageJTextField.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(0, 153, 204)));

        sendJButton.setText("Send ");
        sendJButton.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(0, 153, 204)));
    ...
    private void sendJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendJButtonActionPerformed
        ...
        if(message.isEmpty() || message.equals(null) || message.trim().isEmpty())
        {
