...
public class ManageInvoiceJPanel extends javax.swing.JPanel {
    ...
    private void populateInvoiceTable()
    {
        ...
        for(Invoice invoice : pf.getInvoiceHistory().getInvoiceList())
        {
            ...
            row[0] = invoice;
            row[1] = invoice.getOrder();
            row[2] = invoice.getNoOfImpressions();
            row[3] = invoice.getTotalAmount();
            dtm.addRow(row);
        }
    }
    ...
    private void initComponents() {
        ...
        invoiceJTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Invoice ID", "Order No.", "No Of Impressions", "Amount"
            }
        ) {
        ...
        searchInvoiceJTextField.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(0, 153, 204)));
        ...
        addRequestJButton.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(0, 153, 204)));
        ...
        searchInvoiceJButton.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(0, 153, 204)));
